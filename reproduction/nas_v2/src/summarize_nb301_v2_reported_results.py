...
BUNDLED_ROWS = [
    ...
    ("main_table", "full_proxy_pool_axis_acc", 94.295372),
    ("main_table", "full_proxy_pool_final_acc", 94.482162),
    ("main_table", "full_proxy_pool_final_rank", 2.000000),
    ("main_table", "full_proxy_pool_score_gpu_hours", 4.571389),
    ("main_table", "full_proxy_pool_refinement_gpu_hours", 0.067500),
    ("main_table", "three_proxy_subset_prior_acc", 94.116646),
    ("main_table", "three_proxy_subset_axis_acc", 94.163712),
    ("main_table", "three_proxy_subset_final_acc", 94.390083),
    ("main_table", "three_proxy_subset_final_rank", 3.000000),
    ...
    ("component_ablation", "proxydiff_v2_full_acc", 94.482162),
    ...
    ("refinement_trajectory", "axis_calibrated_selection_acc", 94.295372),
    ("refinement_trajectory", "component_corrected_refinement_acc", 94.482162),
]
