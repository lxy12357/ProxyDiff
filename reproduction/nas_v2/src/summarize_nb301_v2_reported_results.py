...
BUNDLED_ROWS = [
    ("main_table", "full_proxy_pool_prior_acc", 93.862175),
    ("main_table", "full_proxy_pool_axis_acc", 94.637665),
    ("main_table", "full_proxy_pool_final_acc", 94.695648),
    ("main_table", "full_proxy_pool_final_rank", 1.000000),
    ("main_table", "full_proxy_pool_score_gpu_hours", 4.630000),
    ("main_table", "full_proxy_pool_refinement_gpu_hours", 0.120000),
    ("main_table", "three_proxy_subset_prior_acc", 94.515373),
    ("main_table", "three_proxy_subset_axis_acc", 94.515373),
    ("main_table", "three_proxy_subset_final_acc", 94.530296),
    ("main_table", "three_proxy_subset_final_rank", 1.000000),
    ("main_table", "three_proxy_subset_score_gpu_hours", 0.220000),
    ("main_table", "three_proxy_subset_refinement_gpu_hours", 0.120000),
    ...
    ("component_ablation", "proxydiff_v2_full_acc", 94.695648),
    ...
    ("refinement_trajectory", "score_prior_acc", 93.862175),
    ("refinement_trajectory", "axis_calibrated_selection_acc", 94.637665),
    ("refinement_trajectory", "component_corrected_refinement_acc", 94.695648),
]
