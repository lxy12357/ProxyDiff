...
if not (UPSTREAM / "sota").is_dir():
    raise RuntimeError(
        ...
        "reproduction/nas/scripts/setup_nb301_score_dependencies.sh or set "
...
def write_operation_scores(out_dir: Path, method: str, seed: int, batch_size: int, baseline_score, records):
    ...
    payload = {
        ...
        "protocol_revision": (
            ...
            if method == "te_nas"
            else "cell_local_operation_ablation_20260605"
        ),
        "network_scale": network_scale_label(),
        "seed": seed,
        "method_internal_seed": 21 if method == "epsinas" else seed,
        "batch_size": batch_size,
        "backend": {
